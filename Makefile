# This Makefile is for the Acme::PM::Barcelona extension to perl.
#
...
#     ABSTRACT => q[Talks and projects by Barcelona.pm]
#     AUTHOR => q[Alex Muntada <alexm@cpan.org>]
#     DIR => []
#     DISTNAME => q[Acme-PM-Barcelona]
...
INST_LIBDIR      = $(INST_LIB)/Acme/PM
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Acme/PM
...
DISTVNAME = Acme-PM-Barcelona-0.04
